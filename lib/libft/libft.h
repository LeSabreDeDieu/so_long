...
/*   Updated: 2024/01/17 11:45:51 by sgabsi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 */
t_LinkedList			*ft_lstnew(void *content);
 ...
 */
t_LinkedList			*ft_lstlast(t_LinkedList *linked_list);
 ...
 * @return The new list.
 */
t_LinkedList			*ft_lstmap(t_LinkedList *linked_list,
 ...
 */
void					ft_lstadd_front(t_LinkedList **linked_list,
 ...
 * @param new The new node to add.
 */
void					ft_lstadd_back(t_LinkedList **linked_list,
							t_LinkedList *newNode);
 ...
 */
void					ft_lstdelone(t_LinkedList *linked_list,
							void (*del)(void *));
 ...
 * @param del The function used to delete the content of a node.
 */
void					ft_lstclear(t_LinkedList **linked_list,
							void (*del)(void *));
 ...
 * @param f The function to apply to each node.
 */
void					ft_lstiter(t_LinkedList *linked_list,
							void (*f)(void *));
 ...
 */
int						ft_lstsize(t_LinkedList *linked_list);
 ...
 * @file libft.h
 *
 * @brief This file contains the declarations of 
...
/**
	...
	* @brief Locates the first occurrence of the string 'needle' in the string 
...
/**
	...
	* @brief Locates the first occurrence of the character 'c' in 
	the memory area 's'.
...
/**
	...
	* @brief Duplicates the string 's1' and returns a pointer to the 
	duplicated string.
