...
/*   Updated: 2024/04/26 16:24:12 by sgabsi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (key == KEY_DOWN)
		print_image(data, data->player->run[SUD][data->frame_run]->img, i, j);
	else if (key == KEY_RIGHT)
		print_image(data, data->player->idle[1][0]->img, i, j);
	else if (key == KEY_UP)
		print_image(data, data->player->idle[2][0]->img, i, j);
	else if (key == KEY_LEFT)
		print_image(data, data->player->idle[3][0]->img, i, j);
